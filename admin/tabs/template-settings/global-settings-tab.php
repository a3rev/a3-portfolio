...
class A3_Portfolio_Global_Settings_Tab extends A3_Portfolio_Admin_UI
{
	/**
	 * @var string
	 */
...
$a3_portfolio_global_settings_tab = new A3_Portfolio_Global_Settings_Tab();

/**
 * people_contact_grid_view_tab_manager()
 * Define the callback function to show tab content
 */
function a3_portfolio_global_settings_tab_manager() {
	global $a3_portfolio_global_settings_tab;
