...
class A3_Portfolio_Admin_Interface extends A3_Portfolio_Admin_UI
{
			...
			switch( $value['type'] ) {
				...
				case 'upload':
					...
					?><tr valign="top">
						...
						<td class="forminp forminp-<?php echo esc_attr( sanitize_title( $value['type'] ) ); ?>">
                        	<?php echo $description; ?>
                        	<?php echo $a3_portfolio_uploader->upload_input( $name_attribute, $id_attribute, $option_value, $attachment_id, $value['default'], $value['name'], $class, esc_attr( $value['css'] ) , '', $strip_methods );?>
						</td>
					</tr><?php
